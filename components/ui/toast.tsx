...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      'fixed top-1/2 left-1/2 z-[100] flex max-h-screen w-full flex-col-reverse p-4 transform -translate-x-1/2 -translate-y-1/2 md:max-w-[420px]',
      className
    )}
    {...props}
  />
